...
const UpdateMedicalCheckEvent: React.FC<UpdateMedicalCheckEventProps> = ({ eventId, onSuccess, onCancel }) => {
  ...
  return (
    <div className='max-w-4xl mx-auto p-4 max-h-[70vh] overflow-y-auto'>
      <Form form={form} layout='vertical' onFinish={handleSubmit} size='large'>
        ...
        <div className='text-center'>
          <Space size='middle'>
            <Button size='middle' onClick={onCancel} className='rounded-lg min-w-[100px]'>
              Hủy
            </Button>
            <Button
              type='primary'
              ...
              size='middle'
              loading={loading}
              className='bg-blue-500 hover:bg-blue-600 rounded-lg min-w-[100px]'
